...
export default function LandingPage({ onSignIn, isAuthenticated, onSignOut }: LandingPageProps) {
  ...
  return (
    <div className="landing-page">
          ...
          <div className="hero-content">
            ...
            <div className="hero-subtitle-wrapper">
              <p className="hero-subtitle">
                Verse turns Chrome into an Agentic Browser. Just describe what you need, and watch it work.
              </p>
            </div>
      ...
      {/* Demo Video Section */}
      <section ref={videoSectionRef} className={`demo-section ${isVideoVisible ? 'animate-in' : ''}`}>
        <div className="container">
          <div className="video-container">
            <div className="video-wrapper">
              <video ref={videoRef} src="/demo-video.mov" playsInline muted loop preload="auto" className="demo-video">
        ...
        <div className="container">
          ...
          <div className="use-cases-grid">
            ...
            <div className="use-case-card">
              ...
              <p>
                Move through dashboards and professional software with confident guidance—no technical expertise needed.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="faq-list">
            ...
            <div className="faq-item">
              ...
              <div className={openFaq === 2 ? 'faq-answer open' : 'faq-answer'}>
                <p>
                  Yes, Verse is free to use. However, you'll need to provide your own API keys for the LLM provider you
                  choose to use (OpenAI, Anthropic, Gemini, or others). Verse runs entirely in your browser, so you have
                  full control over your AI backend.
                </p>
              </div>
            </div>
            ...
            <div className="faq-item">
              ...
              <div className={openFaq === 3 ? 'faq-answer open' : 'faq-answer'}>
                <p>
                  Absolutely. Verse runs entirely in your browser, meaning all automation happens locally on your
                  machine. Your data never leaves your computer unless you explicitly send it to an LLM provider (which
                  you control).
                </p>
              </div>
            </div>
            ...
            <div className="faq-item">
              ...
              <div className={openFaq === 5 ? 'faq-answer open' : 'faq-answer'}>
                <p>
                  ...
                  account, configure your preferred LLM provider with your API keys in the settings, and you're ready to
                  go. Just open the side panel and describe what you want to automate in plain English.
                </p>
              </div>
            </div>
          </div>
