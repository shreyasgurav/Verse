...
export class AgentContext {
  ...
  async emitEvent(actor: Actors, state: ExecutionState, eventDetails: string, extraData?: { messageType?: 'thinking' | 'final'; isFinalAnswer?: boolean }) {
    const event = new AgentEvent(actor, state, {
      ...
      isFinalAnswer: extraData?.isFinalAnswer,
    });
