...
export const DEFAULT_BROWSER_CONTEXT_CONFIG: BrowserContextConfig = {
  minimumWaitPageLoadTime: 0.05, // Minimal wait - just enough for DOM to settle
  waitForNetworkIdlePageLoadTime: 0.2, // Very short - SPAs have constant background requests
  maximumWaitPageLoadTime: 2.0, // Reduced to prevent debugger timeout
  waitBetweenActions: 0.2, // Faster execution
