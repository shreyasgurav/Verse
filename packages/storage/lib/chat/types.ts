...
export interface ThinkingStep {
  ...
  content: string;
  timestamp: number;
  state: string; // ExecutionState as string for serialization
}
...
export interface Message {
  ...
  messageType?: 'user' | 'assistant' | 'thinking' | 'progress'; // Classify message purpose
  thinkingSteps?: ThinkingStep[]; // Store reasoning steps
