...
export const GeneralSettings = ({ isDarkMode = false }: GeneralSettingsProps) => {
  ...
  return (
    <section className="space-y-6">
      {/* Hide number input spinners (Chrome/Edge/Firefox) */}
      <style>
        {`
        /* Chrome, Safari, Edge */
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            ...
            <input
              ...
              className={`w-20 rounded-lg border border-white/40 bg-transparent text-center ${isDarkMode ? 'text-gray-200' : 'text-gray-200'} px-3 py-2 focus:outline-none focus:ring-0 focus:border-white/40`}
            />
          </div>
